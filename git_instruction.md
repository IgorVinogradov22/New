...
## 12. Инструкция по работе с удаленными репозиториями

* Создать аккаунт на Github.com
* Создать удаленный репозиторий
* Создать локальный репозиторий 
* Создать привязку локального и удаленного репозитариев
* Отправить локальный репозитарий в удаленный при помощи команды:
```
git push
```
* Сделать изменения в удаленном репозитарии с другого компьютера
* Скачать удаленный репозиторий на свой компьютер при помощи команды:
```
git pull
```
